...
public class MagicGenerator extends AGenerator {
    ...
    public MagicGenerator(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public ItemStack getProgressBar() {
        ...
        progressBar.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
