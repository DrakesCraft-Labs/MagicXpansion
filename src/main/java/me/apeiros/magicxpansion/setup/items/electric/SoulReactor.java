...
public abstract class SoulReactor extends Reactor {
    ...
    public SoulReactor(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
                ...
                if (entity instanceof LivingEntity) {
                    if (entity instanceof Player) {
                        if (((Player) entity).getGameMode() == GameMode.CREATIVE || ((Player) entity).getGameMode() == GameMode.SPECTATOR) {
                            ...
                            ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.NAUSEA, 60, 3));
