...
public final class MagicXpansionItems {
    ...
    public static final SlimefunItemStack ENDER_LUMP_4 = new SlimefunItemStack("MX_ENDER_LUMP_4", Material.GOLD_NUGGET, "&5Ender Lump &7- &eIV", "", "&c&oTier: IV");
    ...
    static {
        ARCANIUM_INGOT.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(ARCANIUM_INGOT, ItemFlag.HIDE_ENCHANTS);
    }
    ...
    static {
        SHULKER_ALLOY_INGOT.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(SHULKER_ALLOY_INGOT, ItemFlag.HIDE_ENCHANTS);
    }
    ...
    static {
        NETHER_STAR_BLOCK.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(NETHER_STAR_BLOCK, ItemFlag.HIDE_ENCHANTS);
    }
    ...
    static {
        INFINITY_CROSSBOW.addUnsafeEnchantment(Enchantment.INFINITY, 1);
    }
    ...
    static {
        NETHER_CROSSBOW.addUnsafeEnchantment(Enchantment.FLAME, 5);
        NETHER_CROSSBOW.addUnsafeEnchantment(Enchantment.FIRE_ASPECT, 2);
        NETHER_CROSSBOW.addUnsafeEnchantment(Enchantment.UNBREAKING, 3);
    }
    ...
    static {
        BLESSED_AQUATIC_NETHERITE_INGOT.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(BLESSED_AQUATIC_NETHERITE_INGOT, ItemFlag.HIDE_ENCHANTS);
    }
    ...
    static {
        POSEIDONS_TRIDENT.addUnsafeEnchantment(Enchantment.SHARPNESS, 8);
        POSEIDONS_TRIDENT.addUnsafeEnchantment(Enchantment.UNBREAKING, 8);
        ...
        POSEIDONS_TRIDENT.addUnsafeEnchantment(Enchantment.INFINITY, 1);
    }
    ...
    static {
        STAFF_ENERGIZED_WIND.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(STAFF_ENERGIZED_WIND, ItemFlag.HIDE_ENCHANTS);
    }
    ...
    static {
        ...
        REAPER_SCYTHE.addUnsafeEnchantment(Enchantment.SHARPNESS, 5);
        REAPER_SCYTHE.addUnsafeEnchantment(Enchantment.FIRE_ASPECT, 2);
        REAPER_SCYTHE.addUnsafeEnchantment(Enchantment.UNBREAKING, 10);
    }
    ...
    static {
        SOUL.addUnsafeEnchantment(Enchantment.UNBREAKING, 1);
        Banderas.ocultar(SOUL, ItemFlag.HIDE_ENCHANTS);
    }
